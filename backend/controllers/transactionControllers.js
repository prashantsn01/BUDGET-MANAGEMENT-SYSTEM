            ...
            try {
                  ...
                  const transaction = await prisma.$transaction(
                        async (tx) => {
                              ...
                              // Only expenses count toward budget spending
            ...
            try {
                  ...
                  const transaction = await prisma.$transaction(
                        async (tx) => {
                              ...
                              // Remove old expense from its budget
                              if (
            ...
            try {
                  const deletedTransaction = await prisma.$transaction(
                        async (tx) => {
                              ...
                              // Remove expense from budget before deleting
                              if (
...
export default transactionController;import { PrismaClient } from "@prisma/client";
import { GoogleGenerativeAI } from "@google/generative-ai";
